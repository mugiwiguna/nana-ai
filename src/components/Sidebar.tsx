    ...
    <div className="border-t border-[var(--border-color)] pt-3 mt-3">
      <div className="px-3">
        ...
        {!loaded ? (
          ...
          <>
            <p className="text-[11px] mt-0.5 text-violet-400 flex items-center gap-1">
          ...
          <>
            <p className="text-[11px] mt-0.5 text-[var(--text-secondary)] flex items-center gap-1">
              <svg className="w-3 h-3" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        ...
        <div className="flex flex-col h-full p-4 overflow-y-auto">
          <nav className="flex-1 space-y-4">
            {groups.map((group, gi) => (
              <div key={gi}>
                {group.label && (
                  <p className="px-3 mb-1 text-xs font-semibold uppercase tracking-wider text-[var(--text-secondary)] opacity-60">
                    {group.label}
                  </p>
                )}
