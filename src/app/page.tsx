      ...
      >
        ...
        >
          ...
          >
            <Link
              href="/register"
              className="group relative inline-flex items-center gap-2 bg-gradient-to-r from-[var(--gradient-start)] to-[var(--gradient-end)] text-white font-medium px-8 py-3.5 rounded-xl transition-all duration-300 hover:shadow-lg hover:shadow-[var(--gradient-start)]/25 hover:scale-[1.02] active:scale-[0.98]"
            >
              Mulai Gratis
            ...
            <Link
              href="/#pricing"
              className="inline-flex items-center gap-2 border border-[var(--border-color)] hover:border-[var(--gradient-start)]/40 text-[var(--text-primary)] font-medium px-8 py-3.5 rounded-xl transition-all duration-300 hover:bg-[var(--gradient-start)]/5 active:scale-[0.98]"
            >
              Lihat Harga
            </Link>
          </motion.div>
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link
                  href="/register"
                  className="bg-gradient-to-r from-[var(--gradient-start)] to-[var(--gradient-end)] text-white font-medium px-8 py-3.5 rounded-xl transition-all duration-300 hover:shadow-lg hover:shadow-[var(--gradient-start)]/25 hover:scale-[1.02] active:scale-[0.98]"
                >
                  Mulai Gratis
                </Link>
                <Link
                  href="/login"
                  className="border border-[var(--border-color)] hover:border-[var(--gradient-start)]/40 text-[var(--text-primary)] font-medium px-8 py-3.5 rounded-xl transition-all duration-300 hover:bg-[var(--gradient-start)]/5"
                >
                  Masuk
                </Link>
              </div>
