      ...
      <div className="w-full max-w-sm">
        ...
        <div className="border border-[var(--border-color)] bg-[var(--bg-card)] backdrop-blur-xl rounded-2xl p-8">
          ...
          <div className="text-center mb-8">
            <h1 className="text-2xl font-bold text-[var(--text-primary)]">Masuk</h1>
            <p className="text-sm text-[var(--text-secondary)] mt-1">Selamat datang kembali di nanaAI</p>
          </div>
        ...
        <p className="text-center text-[var(--text-secondary)] text-sm mt-6">
          Belum punya akun?{" "}
          <Link href="/register" className="text-[var(--gradient-start)] hover:underline font-medium">
            Daftar
          </Link>
        </p>
      </div>
