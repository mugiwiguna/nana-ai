    ...
    <main className="min-h-screen bg-[var(--bg-primary)] text-[var(--text-primary)]">
      <section className="pt-32 pb-16 text-center">
        <div className="max-w-4xl mx-auto px-4">
          <div className="mb-8">
            <div className="w-20 h-20 mx-auto rounded-2xl bg-[var(--gradient-start)] flex items-center justify-center text-white mb-6">
          ...
          <div className="glass-card rounded-2xl overflow-hidden border-[var(--gradient-start)]/20">
            <div className="bg-[var(--gradient-start)]/5 p-8 text-center border-b border-[var(--border-color)]">
              ...
              <a
                ...
                className="inline-flex items-center gap-2 text-white font-semibold px-8 py-4 rounded-2xl bg-[var(--gradient-start)] hover:opacity-90 hover:scale-[1.03] active:scale-[0.98] transition-all duration-300"
              >
